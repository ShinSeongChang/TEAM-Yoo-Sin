...
public class HornetBehavior_S : MonoBehaviour
{
    ...
    private void CheckStun()
    {
        ...
        {
            // Legacy : Shin
            // 엔딩씬 테스트를 위한 GameManager.instance.EndingScene(); 메소드 추가
            // 현재 죽는구간이 어디인지 체크를 하지못해서 첫타 공격하자마자 죽게 만들었음.
